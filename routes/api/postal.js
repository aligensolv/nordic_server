...
const router = Router()
import Postal from '../../models/PostalViolation.js'
...
router.post('/postals',upload.single('violation'),async (req,res) =>{
  ...
  try{
    ...
    const htmlTemplate = readFileSync('templates/postal.html', 'utf8');
  ...
  let filename = `post_${pnid}_${Randomstring.generate(10)}.pdf`
